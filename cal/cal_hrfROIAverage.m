...
opts = optimset('MaxFunEvals', 500, 'Display', 'off');
[x_doubleGamma, resnorm, ~, exitflag, output] = lsqcurvefit(@def_HRFDoubleGamma, p_doubleGamma, t, hrf_Deconv, lb_DoubleGamma, ub_DoubleGamma, opts);
subplot(3,2,3)
% disp(x_doubleGamma)
fittedHRF = def_HRFDoubleGamma(x_doubleGamma,t);
plot(t,fittedHRF)
hold on
plot(t,def_HRFDoubleGamma(p_doubleGamma,t), '--r')
% deconvHRF = a(7,:)
...
opts = optimset('MaxFunEvals', 500, 'Display', 'off');
[x_Gamma, resnorm, ~, exitflag, output] = lsqcurvefit(@def_HRFGamma, p_Gamma, t, hrf_Deconv, lb_Gamma, ub_Gamma, opts);
subplot(3,2,4)
% disp(x_Gamma)
fittedHRF = def_HRFGamma(x_Gamma,t);
plot(t,fittedHRF)
hold on
plot(t,def_HRFGamma(p_Gamma,t), '--r')
% deconvHRF = a(7,:)
deconvHRF = hrf_Deconv;
plot(t,deconvHRF)
title('Gamma')
...
opts = optimset('MaxFunEvals', 500, 'Display', 'off');
[x_dGamma, resnorm, ~, exitflag, output] = lsqcurvefit(@def_HRFDiffOfGamma, p_dGamma, t, hrf_Deconv, lb_dGamma, ub_dGamma, opts);
subplot(3,2,5)
% disp(x_dGamma)
fittedHRF = def_HRFDiffOfGamma(x_dGamma,t);
plot(t,fittedHRF)
hold on
plot(t,def_HRFDiffOfGamma(p_dGamma,t), '--r')
plot(t,hrf_Deconv)
